...
const ALLOWED_EDITABLE = {
  ...
  "feature-picky-eating-title": { label: "Card 5 title", maxLen: 60, group: "What it helps with" },
  "feature-picky-eating-body": { label: "Card 5 description", maxLen: 200, group: "What it helps with" },
  "feature-separation-anxiety-title": { label: "Card 6 title", maxLen: 60, group: "What it helps with" },
  "feature-separation-anxiety-body": { label: "Card 6 description", maxLen: 200, group: "What it helps with" },
  "feature-backtalk-title": { label: "Card 7 title", maxLen: 60, group: "What it helps with" },
  "feature-backtalk-body": { label: "Card 7 description", maxLen: 200, group: "What it helps with" },
  "feature-listening-title": { label: "Card 8 title", maxLen: 60, group: "What it helps with" },
  "feature-listening-body": { label: "Card 8 description", maxLen: 200, group: "What it helps with" },
  "feature-honesty-title": { label: "Card 9 title", maxLen: 60, group: "What it helps with" },
  "feature-honesty-body": { label: "Card 9 description", maxLen: 200, group: "What it helps with" },
  "feature-school-age-anger-title": { label: "Card 10 title", maxLen: 60, group: "What it helps with" },
  "feature-school-age-anger-body": { label: "Card 10 description", maxLen: 200, group: "What it helps with" },
  "feature-worry-title": { label: "Card 11 title", maxLen: 60, group: "What it helps with" },
  "feature-worry-body": { label: "Card 11 description", maxLen: 200, group: "What it helps with" },
  "feature-bullying-title": { label: "Card 12 title", maxLen: 60, group: "What it helps with" },
  "feature-bullying-body": { label: "Card 12 description", maxLen: 200, group: "What it helps with" },
  "feature-social-media-title": { label: "Card 13 title", maxLen: 60, group: "What it helps with" },
